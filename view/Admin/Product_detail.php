                ...
                <form action="?controller=Admin&action=update_Product" method="post" enctype="multipart/form-data">
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <div class="form-floating mb-3">
                            <a>Mã sản phẩm</a>
                            <input type="text" class="form-control" id="floatingName" name="id"
                                value="<?php echo $result['MaSP']?>" readonly>
                            <label for="floatingName"></label>
                        </div>
                        <div class="form-floating mb-3">
                            <a>Tên sản phẩm</a>
                            <input type="text" class="form-control" id="floatingQuantity" name="product_name"
                                placeholder="" value="<?php echo $result['TenSP']?>">
                            <label for="floatingQuantity"></label>
                        </div>
                        <div class="form-floating">
                            <textarea class="form-control" placeholder="Leave a comment here" 
                            id="floatingTextarea" name="desc" style="height: 150px;"><?php echo $result['MoTa'] ?></textarea>
                        ...
                        <div class="bg-light rounded h-100 mb-3">
                            ...
                            <select class="form-select mb-3" name="dmsp" aria-label="Default select example">
                                ...
                                ?>
                                <option <?php if($result['MaDMSP'] == $value['MaDMSP']){?> selected 
                                    <?php
                                            }
                                    ?>
                                    value="<?php echo $value['MaDMSP'] ?>"><?php echo $value['TenDM'] ?></option>
                                <?php
                        ...
                        <div class="bg-light rounded h-100 mb-3">
                            ...
                            <select class="form-select mb-3" name="ncc" aria-label="Default select example">
                                ...
                                ?>
                                <option <?php if($result['MaNCC'] == $value['MaNCC']){?> selected 
                                    <?php
                                            }
                                    ?>
                                    value="<?php echo $value['MaNCC'] ?>"><?php echo $value['TenNCC'] ?></option>
                                <?php
                        ...
                        <div class="bg-light rounded h-100 mb-3">
                            ...
                            <select class="form-select mb-3" name="brand" aria-label="Default select example">
                                ...
                                ?>
                                <option <?php if($result['MaTH'] == $value['MaTH']){?> selected 
                                    <?php
                                            }
                                    ?>
                                    value="<?php echo $value['MaTH'] ?>"><?php echo $value['TenTH'] ?></option>
                                <?php
                    ...
                    <div class="row g-4">
                        <div class="col-sm-12 col-xl-6">
                            <div class="bg-light rounded h-100 p-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="memory" name="gianhap" value="<?php echo $result['GiaNhap']?>">
                                </div>
                                <div class="mb-3">
                                    <label for="color" class="form-label">Giá bán</label>
                                    <input type="text" class="form-control" id="color" name="giaxuat" value="<?php echo $result['GiaXuat']?>">
                                </div>
                                <div class="mb-3">
                                    ...
                                    ?>
                                    <input type="datetime-local" class="form-control" id="startDateTime" name="ngay_bd" value="<?php echo $defaultTime; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="ghichu" class="form-label">Ghi Chú</label>
                                    <input type="text" class="form-control" id="ghichu" name="ghichu" value="<?php echo $result['GhiChu']?>">
                                </div>
                                <div class="mb-3">
                                    <label for="ghichu" class="form-label">Các màu sắc của sản phẩm</label>
                                    <input type="text" class="form-control" id="color" name="color" value="<?php echo $result['MauSac']?>">
                                </div>
                            </div>
                        </div>
                        <!-- img -->
                                ...
                                <div class="d-flex align-items-center border-bottom py-2">
                                    <div class="w-100 ms-3">
                                        <div class="d-flex w-100 align-items-center justify-content-between">
                                            <img src="upload/<?php echo $result['TenHinhAnh']; ?>" width="420">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container-fluid pt-4 px-4">
                            <div class="alert alert-primary" role="alert">
                                Danh sách hình ảnh của sản phẩm: "<?php echo $result['TenSP']; ?>"
                            </div>
                            <div class="row g-4">
                                <?php 
