                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $stt; ?></td>
                                    <td><?php echo $value['MaPDH']; ?></td>
                                    <td><?php echo $value['MaKH']; ?></td>
                                    <td><p class="text-dark">Chưa xác nhận</p></td>
                                    <td>
                                        <a class="btn btn-sm btn-primary" href="?controller=Admin&action=order_detail&id=<?php echo $value['MaPDH']; ?>&kh_id=<?php echo $value['MaKH']; ?>">Chi tiết</a>
                                    </td>
                                </tr>
                                <?php
                                    $stt++;   
